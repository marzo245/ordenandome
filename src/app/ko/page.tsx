import { db, tasks, ko_entries, ko_subprocesos } from '@/db';
...
export default async function KoPage() {
  const [session, tasksRows, koRows, spRows] = await Promise.all([
    auth(),
  ...
  return (
    ...
    >
      ...
      <KoManager initialEntries={koRows} initialSubprocesos={spRows} />
    </DashboardShell>
  );
}
